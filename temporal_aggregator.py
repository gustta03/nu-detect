...
class TemporalAggregator:
    ...
    def __init__(self, 
        ...
        # Janela deslizante de frames
        self.frame_window = deque(maxlen=window_size)
        
        # Contador de frames consecutivos NSFW
        self.consecutive_nsfw_count = 0
        
        # Score acumulado
        self.accumulated_score = 0.0
        
        # Estatísticas cumulativas de TODOS os frames processados
    ...
    def add_frame(self, severity_result: Dict) -> Dict:
        ...
        frame_data = {
            ...
            'timestamp': len(self.frame_window)  # Índice do frame
        }
        self.frame_window.append(frame_data)
        
        # Atualiza estatísticas cumulativas
        ...
        # Critério 3: Janela com maioria NSFW
        if not confirmed_nudity and len(self.frame_window) >= self.window_size:
            ...
            if nsfw_ratio >= 0.6:  # 60% dos frames na janela são NSFW
                confirmed_nudity = True
